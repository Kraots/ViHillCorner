...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        helpEm = discord.Embed(description="", color=0x2F3136)
        ...
        helpEm.add_field(name="User Commands", value="`revive`, `ee`, `nick`, `profile`, `created`, `joined`, `av`, `serverinfo`, `snippets`, `actions`, `waifu`, `invite`, `ad`, `rawad`, `suggest`, `spotify`, `meme`,`cat`, `dog`")
    ...
    async def meme(self, ctx):
      meme = discord.Embed(color=0x2F3136, description="Usage: `.meme`\n\nSends a random meme! ;3")
      await ctx.channel.send(embed=meme)

    @help.command()
    async def cat(self, ctx):
      meme = discord.Embed(color=0x2F3136, description="Usage: `.cat`\n\nSends a random cat pic/vid! ;3")
      await ctx.channel.send(embed=meme)
