	...
	async def on_message(self, message: discord.Message):
		...
		if message.guild:
			...
			if message.author.id == twil.id:
				try:
					if twil.nick != "xxtwilightxx the third horniest":
						await twil.edit(nick="xxtwilightxx the third horniest")
						await message.channel.send("Nope, it's `xxtwilightxx the third horniest` :smirk: ")
				except:
					await twil.edit(nick="xxtwilightxx the third horniest")
					await message.channel.send("Nope, it's `xxtwilightxx the third horniest` :smirk: ")
